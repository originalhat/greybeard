...
Each domain record follows `templates/domain-record.md`. Produce one file per domain at `$GREYBEARD_DATA/output/knowledge-extraction/{repo}/domains/[domain-name].md`.

Also produce:
- `$GREYBEARD_DATA/output/knowledge-extraction/{repo}/open-questions.md` — consolidated unanswered questions from all domains (copy from interrogator output, filtered to unresolved)
- `$GREYBEARD_DATA/output/knowledge-extraction/{repo}/coverage-report.md` — brief summary of what was and wasn't captured
