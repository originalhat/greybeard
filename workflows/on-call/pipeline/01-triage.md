...
- **Snippets go inline in the reply**, one code block per round. Do not move them to a linked file; a linked file is only for member identifiers on production tickets.
